...
export const GrubList: FC<IGrubList> = memo(
  ({ subHeader, data, className, disabled, addLabel, actions, onAction, onClickAdd, pages, page, onPageChange }) => {
    ...
    return (
      <>
        ...
        >
          {data.map((item, index) => (
            <ListItem disabled={disabled} key={index} secondaryAction={generateActions(item)}>
              <ListItemButton>
