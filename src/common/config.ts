...
export const appConfig: IGlobalConstants = {
  ...
  siteUrl: process.env.NODE_ENV == 'production' ? `${window.__RUNTIME_CONFIG__.SITE_URL}/${window.__RUNTIME_CONFIG__.APP_SLUG}` : process.env.REACT_APP_SITE_URL || 'http://localhost:3001',
